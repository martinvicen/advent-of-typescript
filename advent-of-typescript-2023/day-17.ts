...
// https://typehero.dev/challenge/day-17/submissions/130027

type RockPaperScissors = '👊🏻' | '🖐🏾' | '✌🏽';

type WhoWins<
  Oponent extends RockPaperScissors,
  Me extends RockPaperScissors
> = Equal<Oponent, Me> extends true
  ? 'draw'
  : Equal<Oponent, '👊🏻'> extends true
  ? Equal<Me, '🖐🏾'> extends true
    ? 'win'
    : 'lose'
  : Equal<Oponent, '🖐🏾'> extends true
  ? Equal<Me, '✌🏽'> extends true
