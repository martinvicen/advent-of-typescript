...
// https://typehero.dev/challenge/day-12/submissions/130150

type FindSanta<T extends string[], Search extends string = '🎅🏼', Index extends string[] = []> =
	T extends [infer First extends string, ...infer Rest extends string[]]
		? First extends Search
			? Index['length']
			: FindSanta<Rest, Search, [...Index, First]>
		: never;
