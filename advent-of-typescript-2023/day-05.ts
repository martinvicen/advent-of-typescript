...
// https://typehero.dev/challenge/day-5/submissions/126392

// type TupleType = Readonly<Array<boolean | number | string | string[]>>;
type TupleType = Readonly<Array<NonNullable<unknown>>>;
type SantasList<T extends TupleType, U extends TupleType> = [...T, ...U];
