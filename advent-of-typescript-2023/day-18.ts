...
// https://typehero.dev/challenge/day-18/submissions/133891

type Count<Sack extends Array<ToySack[number]>, Search extends string, Result extends string[] = []> =
	Sack extends [infer First extends ToySack[number], ...infer Rest extends Array<ToySack[number]>]
		? First extends Search
			? Count<Rest, Search, [...Result, First]>
			: Count<Rest, Search, Result>
		: Result['length'];
